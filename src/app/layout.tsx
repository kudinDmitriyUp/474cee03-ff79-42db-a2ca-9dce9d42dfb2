...
export const metadata: Metadata = {
  title: "FireHub - Real-Time Fire Safety Monitoring & Emergency Response",
  description: "AI-powered fire detection and emergency coordination platform. Detect fires 47 seconds faster, reduce false alarms by 94%, and coordinate emergency response instantly.",
  keywords: "fire safety, fire detection, emergency response, smoke detector, fire alarm system, building safety, fire monitoring",
  metadataBase: new URL("https://firehub.io"),
  alternates: {
    canonical: "https://firehub.io"
  },
  openGraph: {
    title: "FireHub - Fire Safety Reimagined",
    description: "Protect your building with AI-powered fire detection and real-time emergency coordination.",
    url: "https://firehub.io",
    siteName: "FireHub",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35zM4fOy9cqxgTNTBAZnIPKH5wN/uploaded-1764108479541-ps4uxa33.jpg",
        alt: "FireHub fire safety monitoring dashboard"
      }
    ]
  },
  twitter: {
    ...
    title: "FireHub - Fire Safety Reimagined",
    description: "AI-powered detection. Real-time coordination. Faster response.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35zM4fOy9cqxgTNTBAZnIPKH5wN/uploaded-1764108479541-ps4uxa33.jpg"]
  },
  robots: {
    index: true,
    follow: true
